	...
	<div class="container py-4 py-xl-5" style="width: 360px;">
		...
		<div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3" style="width: 360px;height: 150px;">
			...
			<div class="col" style="width: 120px;margin-top: 30px;">
				<div class="text-center d-flex flex-column align-items-center align-items-xl-center">
					<div class="bs-icon-lg bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block mb-3 bs-icon lg"><img style="width: 100%;height: 100%;" src="../assets/img/1483848893960336.png"></div>
					<div class="px-3"><span style="font-size: 20px;font-weight: bold;">분식</span></div>
				</div>
			</div>
		</div>
		<div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3" style="width: 360px;height: 150px;">
			<div class="col" style="width: 120px;height: 150px;margin-top: 60px;">
				<div class="text-center d-flex flex-column align-items-center align-items-xl-center">
					...
					<div class="px-3"><span style="font-size: 20px;font-weight: bold;">1인분</span></div>
				</div>
			</div>
			<div class="col" style="width: 120px;height: 150px;margin-top: 60px;">
				<div class="text-center d-flex flex-column align-items-center align-items-xl-center">
