...
<body style="text-align: center;">
	...
	<div class="d-flex flex-column align-items-center"
		...
		<div style="background: white; margin-top: 20px; width: 350px; height: 100px;
					flex-direction: row;">
			<img style="width: 100px; height: 100px;"
			src="../../resource/logo/bunri1.png">
			<img style="width: 100px; height: 100px;"
			src="../../resource/logo/bunri2.png">
			<img style="width: 100px; height: 100px;"
			src="../../resource/logo/bunri3.png">
		</div>
