	...
	<div class="container m-auto" style="max-width: 80%;min-width: 300px;width: 300px;">
		<div class="row" style="width: 300px;max-width: 90%;min-width: 300px;margin-bottom: 20px;margin-top: 10px;">
			<div class="col-md-6" style="padding-right: 0px;padding-left: 0px;width: 150px;">
				<img style="height: 180px;width: 150px;" src="${eventList.get(param.list).eventImageurl}">
			</div>
			<div class="col-md-6" style="width: 150px;">
				<ul>
					<li style="font-size: 20px;font-weight: bold;">응애 치킨</li>
					<li>${eventList.get(param.list).eventTitle}</li>
					<li>${eventList.get(param.list).eventContents}</li>
					<li>${eventList.get(param.list).eventGoods}</li>
					<li>${eventList.get(param.list).eventStart}</li>
					<li>${eventList.get(param.list).eventEnd}</li>
					<li>${eventList.get(param.list).eventOngoing}</li>
				</ul>
			</div>
		</div>
	</div>
		...
		<section class="py-4 py-xl-5" style="margin-top: -17.5px;">
			<div class="container" style="padding-right: 0px;margin-right: 0px;">
				...
				border: 1px solid rgb(25,155,221);padding-left: 0px;margin-left: -20px;">
					<div class="d-flex justify-content-between" style="width: 100%;background: rgb(255,255,255);">
						<input type="text" style="padding-top: 0px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;width: 80%;">
						<button class="btn btn-primary" type="button" style="font-family: 'Source Sans Pro', sans-serif;font-size: 15px;padding: 6px 12px;
						padding-top: 0;padding-right: 0;padding-bottom: 0;padding-left: 0;background: rgb(162,207,230);color: #000000;margin: 0px;
						margin-top: 0px;margin-right: 0px;border-style: none;font-weight: bold;width: 15%;">
					...
					<div class="text-start" style="margin-bottom: 0px;background: var(--bs-white);border-bottom: 2px solid var(--bs-gray-dark);padding-bottom: 5px;">
						...
						<div class="text-start d-flex flex-row align-items-center" style="background: var(--bs-white);margin-top: 0px;padding-bottom: 0px;">
							<button class="btn btn-primary text-center" type="button" style="padding: 0px;padding-top: 0px;background: rgba(25,155,221,0);font-size: 13px;
							...
							<span class="text-center" style="margin-left: 0px;height: 100%;">220</span>
						</div>
						<div class="d-flex justify-content-between" style="width: 100%;background: rgb(255,255,255);">
							<input type="text" style="padding-top: 0px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;width: 80%;">
							<button class="btn btn-primary" type="button" style="font-family: 'Source Sans Pro', sans-serif;
							font-size: 15px;padding: 6px 12px;padding-top: 0;padding-right: 0;padding-bottom: 0;padding-left: 0;background: rgb(162,207,230);
							color: #000000;margin: 0px;margin-top: 0px;margin-right: 0px;border-style: none;font-weight: bold;width: 15%;">
								<span style="width: 10%;font-size: 14px;">댓글 달기</span>
							</button>
						</div>
					</div>
					...
					border-bottom-width: 2px;border-bottom-color: var(--bs-gray-dark);">
						<div class="text-start" style="width: 80%;border-bottom-width: 2px;border-bottom-style: solid;padding-bottom: 5px;background: var(--bs-white);">
							...
							<div class="text-start d-flex flex-row align-items-center" style="background: var(--bs-white);margin-top: 0px;padding-bottom: 0px;">
								...
								<span class="text-center" style="margin-left: 0px;height: 100%;">120</span>
							</div>
							<div class="text-end" style="margin-bottom: 0px;margin-left: 0px;background: var(--bs-body-bg);width: 100%;">
								<div class="text-end d-flex justify-content-between" style="width: 100%;background: rgb(255,255,255);">
									<input class="justify-content-between" type="text" style="padding-top: 0px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;margin-right: 0px;width: 75%;">
									<button class="btn btn-primary" type="button" style="font-family: 'Source Sans Pro', sans-serif;font-size: 11px;
									padding: 6px 12px;padding-top: 0;padding-right: 0;padding-bottom: 0;padding-left: 0;background: rgb(162,207,230);
									color: #000000;margin: 0px;margin-top: 0px;margin-right: 0px;width: 20%;border-style: none;font-weight: bold;">
										<span style="font-size: 15px;">댓글 달기</span>
									</button>
								</div>
							</div>
						</div>
